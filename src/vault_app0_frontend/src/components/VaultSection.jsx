                ...
                {entry.unlock_time && (
                  <>
                    ...
                    <div>
                      ...
                      <span className={`font-semibold ml-2 ${entry.can_unlock ? 'text-green-600' : 'text-orange-600'}`}>
        ...
        <div className="border-t border-slate-200/60 pt-6">
          ...
          <div className="glass rounded-lg p-4 mb-6">
            ...
            <input
              ...
              step="0.01"
              min="0"
              className="w-full px-3 py-2 bg-white/90 border border-slate-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-slate-900 placeholder-slate-400"
              required
            />
          </div>
